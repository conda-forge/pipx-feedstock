...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pipx-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14897&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pipx-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pipx` can be installed with:

```
conda install pipx
```

It is possible to list all of the versions of `pipx` available on your platform with:
